...
dat_raw_nozerob$Mean_Spike_Conc[dat_raw_nozerob$Spike_Âµg_L == 0] <- 0

# There was some missing spike concentrations for 100 ug/L for BW3m July
dat_raw_nozerob$Mean_Spike_Conc[dat_raw_nozerob$Spike_Âµg_L == 100 & is.na(dat_raw_nozerob$Mean_Spike_Conc)] <- 117.5
